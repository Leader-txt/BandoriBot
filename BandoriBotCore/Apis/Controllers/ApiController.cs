...
namespace BandoriBot.Apis.Controllers
{
    ...
    public class ApiController : Controller
    {
        ...
        */
        ...
        [HttpGet("get")]
        public async Task<ActionResult<Services.Record[]>> Get(string keyword = null, long qq = 0, long group = 0, long starttime = 0, long endtime = 0, int limit = 100)
        {
            if (!await CheckPermission("get")) return BadRequest();
            IQueryable<Services.Record> result = RecordDatabaseManager.GetRecords();
